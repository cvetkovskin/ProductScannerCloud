...
function productsRoute() {
  ...
  products.all('/save', function(req, res) {
     console.log(new Date(), 'In /products/save  POST / req.body=', req.body); 
    ...
    var options = {
        ...
        "fields": { // The structure of the entry/row data. A data is analogous to "Row" in MySql or "Documents" in MongoDB
            ...
            "thumbnail" : req.body.entry.thumbnail,
            "photo" : req.body.entry.photo,
            "desc" : req.body.entry.desc,
            "stock": req.body.entry.stock, 
            "code" : req.body.entry.code,
            "address": req.body.entry.address,
            "location": req.body.entry.location, 
            "telephone": req.body.entry.telephone,
            "updated_at": req.body.entry.updated_at
    }
    };
    $fh.db(options, function (err, data) {
        if (err) {
        ...
        res.json({id: data.guid, status: found});
    });
  ...
  products.all('/save_img', function(req, res) {
     console.log(new Date(), 'In /products/save_img  POST / req.body='); 
    ...
    $fh.db(options, function (err, entity) {
        ...
        entFields.photo = req.body.photo;
